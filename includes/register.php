<div class="register_pop" id = "register_pop">
   <div class="container">
      <div class="frame">
         <div class="nav">
            <ul class="links">
         ...
         <div>
            ...
            <form class="form-signup" action="index" method="post" name="form">
               <label for="fullname">Full name</label>
               <input class="form-styling" type="text" name="fullname" placeholder="" id="fullname"/>
               ...
               <input class="form-styling" type="password" name="confirmpassword" placeholder=""  id="confirm"/>
